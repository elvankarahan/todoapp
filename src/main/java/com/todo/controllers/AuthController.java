...
import com.todo.payload.request.SignupRequest;
...
public class AuthController {
    ...
    @PostMapping("/signin")
    @Operation(summary = "Sing-in", description = "Sing in with username and password")
    @ApiResponse(responseCode = "200", description = "Returns User object with token")
    ...
    @Operation(summary = "Sing-up", description = "Takes signUpRequest body that contains username, password, email and role")
    @PostMapping("/signup")
